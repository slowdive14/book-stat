...
이렇게 하면 해당 노트를 열 때마다 항상 지정된 날짜의 비교를 볼 수 있습니다. `daily-note-comparison-example.md` 파일을 참고하세요.

**방법 2: 코드에서 직접 지정**

DataviewJS 코드 블록 상단(6번째 줄)의 주석을 제거하고 날짜 수정:

```javascript
// 이 줄의 주석을 제거하고 원하는 날짜로 변경
const targetDate = moment('2024-01-15');
```

**방법 3: 그냥 오늘 날짜 사용**

위 두 방법을 사용하지 않으면 자동으로 오늘 날짜를 사용합니다.
